...
try {
    ...
    Paragraph title = new Paragraph("Reporte de Categorías de Habitación", FontFactory.getFont(FontFactory.HELVETICA_BOLD, 18, BaseColor.BLACK));
    ...
    // Crear tabla para mostrar los datos de las categorías de habitación
    ...
    cell = new PdfPCell(new Phrase("Código de Habitación", FontFactory.getFont(FontFactory.HELVETICA_BOLD, 12, BaseColor.WHITE)));
    cell.setBackgroundColor(BaseColor.BLUE);
    table.addCell(cell);
    ...
    cell = new PdfPCell(new Phrase("Precio de Habitación", FontFactory.getFont(FontFactory.HELVETICA_BOLD, 12, BaseColor.WHITE)));
    cell.setBackgroundColor(BaseColor.BLUE);
    table.addCell(cell);
