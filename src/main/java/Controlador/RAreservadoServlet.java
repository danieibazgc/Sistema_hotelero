...
@WebServlet(urlPatterns = {"/RAreservadoServlet"})
public class RAreservadoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            request.getRequestDispatcher("../vistas/rareservado.jsp").forward(request, response);
